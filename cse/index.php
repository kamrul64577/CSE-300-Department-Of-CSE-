          ...
          <div class="col-lg-9">
            ...
            <?php while($row = mysqli_fetch_assoc($result)) { ?>
              <div class="notice-content">
                 ...
                 <hr >
                  <a  href="notice-details.php?id=<?php echo $row['id'] ?>"  class="btn my-4">Read More ...</a>
              </div>
            <?php } ?>
  ...
  <div class="container">
      ...
      <div class="row text-center">
          <div class="col-lg-3 col-md-6 text-center">
              <img src="img/teacher.jpg" alt="" class="img-fluid  mx-auto">
              <h3 class="py-3">10+</h3>
              <h2 class="pb-3">Teachers</h2>
          </div>
          <div class="col-lg-3  col-md-6  ">
              <img src="img/student.jpg" alt="" class="img-fluid  mx-auto">
              <h3 class="py-3">600+</h3>
              <h2 class="pb-3">Students</h2>
          </div>
          <div class="col-lg-3  col-md-6 text-center  ">
              <img src="img/courses.jpg" alt="" class="img-fluid  mx-auto">
              <h3 class="py-3">150+</h3>
              <h2 class="pb-3">Credits</h2>
          </div>
          <div class="col-lg-3  col-md-6 text-center  ">
              <img src="img/classroom.jpg" alt="" class="img-fluid mx-auto">
              <h3 class="py-3">15+</h3>
