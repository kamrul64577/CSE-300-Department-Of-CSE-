  ...
  <div class="container py-5 ">
        <div class="row">
            <div class="col-lg-8 e">
                ...
                <form action="facility-update.php?id=<?php echo $id; ?>" enctype="multipart/form-data" method="POST">
                    <div class="form-group">
                        <label for="title"><h4>Title</h4></label>
                        <input type="text" name="title" class="form-control" placeholder="Title"  value = "<?php echo $data['title']?>" >
                    </div>
                    <div class="form-group">
                        <label for="pdf"><h4>Image</h4></label>
                        <input type="file" name="img">
                        <a href="<?php echo $row['img']; ?>"  class="btn btn-primary">  <?php echo $data['img']; ?> </a>
                    </div>
                    <div class="form-group">
                        <label for="facility_details"><h4>Write Your Facility</h4></label>
                        <textarea  name="facility_details" placeholder="Enter Facility details" class="form-control" cols="30" rows="10"><?php echo $data['facility_details'];?></textarea>
