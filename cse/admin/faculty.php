...
<nav class="navbar navbar-dark bg-dark navbar-expand">
            ...
            <div class="col-md-12">
               <!-- <h3><a href="notice-add.php">+ Add Notice</a></h3>-->
                <div class="card">
                    ...
                    <a href="faculty-add.php" class="btn btn-primary add mb-5 mt-3">+ Add Faculty Member</a>
                            ...
                            <?php while($row = mysqli_fetch_assoc($result)) { ?>
                                         ...
                                         <div class="col-lg-9">
                                            <div class="card text-center">
                                                ...
                                                <div class="card-body">
                                                 ...
                                                 <img style = "width:200px; height:200px" src="<?php echo $row['img']; ?>" alt="">
                                                <h4 class="my-3"><?php echo $row['designation']; ?></h4>
                                                <h5 class="my-3"><?php echo $row['qualification'] ?></h5>
                                                <h5 class="my-3"><?php echo $row['institute'] ?></h5>
                                                </div>
                                            </div>
                                         </div>
                                         <hr>
                                    ...
                                    <a href="faculty-edit.php?id=<?php echo $row['id'] ?>" class="btn btn-success" > Edit  </a>
                                        <a href="faculty-delete.php?id=<?php echo $row['id'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure?')"> Delete </a>
                                         </div>
                                     </div>
                                     <hr>
                                    <!-- <?php echo $row['pdf']; ?> -->
  ...
  <?php unset($_SESSION['edit_f']) ?>
  <?php unset($_SESSION['add_f']) ?>
