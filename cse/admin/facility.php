...
<nav class="navbar navbar-dark bg-dark navbar-expand">
    ...
    <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item px-3 active"><a href="facility.php" class="nav-link">Facility</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <a href="facility-add.php" class="btn btn-primary add mb-5 mt-3">+ Add Facility</a>
                            ...
                            <?php while($row = mysqli_fetch_assoc($result)) { ?>
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="col-lg-4">
                                             ...
                                             <h5> <?php echo $row['facility_details']; ?> </h5>
                                         </div>
                                         <hr>
                                         <div class="col-lg-3">
                                         
                                         <a href="<?php echo $row['img']; ?>"  class="btn btn-secondary">View</a>
                                    
                                    <a href="facility-edit.php?id=<?php echo $row['id'] ?>" class="btn btn-success" > Edit  </a>
                                        <a href="facility-delete.php?id=<?php echo $row['id'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure?')"> Delete </a>
                                         </div>
                                     </div>
                                     <hr>
