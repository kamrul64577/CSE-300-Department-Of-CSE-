<?php
  ...
  $sql = "SELECT * from notice-details";
...
<section id="notice-full" class="my-5">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card ">
              ...
              <div class="col-md-12">
                      <div class="card py-3">
                          ...
                          <p class="lead p-3"><?php echo $row['notice-details'] ?></p>
                      </div>
              </div>

              <div class="col-md-6 offset-3 text-center my-4">
                 <a href="<?php echo 'admin/'.$row['pdf']; ?>" target="_blank"
                         class="btn btn-success"><h3>Click Here to See Pdf</h3></a>
              </div>
